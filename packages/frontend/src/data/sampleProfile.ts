...
export const sampleExtendedProfileData: ExtendedProfileData = {
  ...
  experience: [
    ...
    },
    {
      ...
      client: 'Barclays Bank - Universal banking offering personal and business accounts, loans, and savings accounts in both the UK and the US.',
